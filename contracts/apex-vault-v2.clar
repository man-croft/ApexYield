;; title: apex-vault-v2
;; version: 2.0.0
;; summary: Apex Yield Vault V2 - Enhanced yield-bearing vault for USDCx
;; description: A DeFi vault that accepts USDCx deposits and issues apUSDCx share tokens.
;;              Implements block-based yield simulation with 13.5% APY.
;;              Uses mock-usdcx for testing (compatible with real USDCx via same SIP-010 interface)
...
(define-public (withdraw (shares uint))
  (let (
    ...
    ;; Transfer USDCx from vault to user using Clarity 4 as-contract?
    (try! (as-contract? 
